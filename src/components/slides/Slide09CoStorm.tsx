    ...
    <SlideShell>
      ...
      <Content>
        <div className="flex w-full flex-wrap items-center gap-8">
          <FlowNode title="① 建立公文知识库" subtitle="内容 · 结构 · 来源" />
          <div className="flex-none text-ink-dim opacity-75">
            <svg className="block h-11 w-11">
              <use href="#ic-ar" />
            </svg>
          </div>
          <FlowNode accent="red" title="② 检索材料与范文" subtitle="混合检索 · 查询改写" />
          <div className="flex-none text-ink-dim opacity-75">
            <svg className="block h-11 w-11">
              <use href="#ic-ar" />
            </svg>
          ...
          <FlowNode accent="red" title="④ 多视角检索与证据整编" subtitle="引用片段 · 证据核对" />
          <div className="flex-none text-ink-dim opacity-75">
            <svg className="block h-11 w-11">
              <use href="#ic-ar" />
            </svg>
          </div>
          <FlowNode accent="gold" title="⑤ 分段写作与质量检查" subtitle="评审 · 润色 · 格式渲染" />
        </div>
        <Caption>
