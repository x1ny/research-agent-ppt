  ...
  return (
    <SlideShell>
      ...
      <Content>
        <div className="grid w-full max-w-[1480px] grid-cols-[1.12fr_1fr_1fr] items-stretch gap-6">
          <div className="min-h-[470px] rounded-[10px] border border-line bg-panel px-[26px] py-6">
            ...
            <div className="border-b border-dashed border-line-soft py-3.5 last:border-b-0">
              <span className="mb-[7px] inline-block rounded-full bg-accent-wash px-2 py-1 font-mono text-[0.62rem] text-accent-deep">
                开头
              </span>
          ...
          <div className="min-h-[470px] rounded-[10px] border border-line border-t-4 border-t-accent bg-panel-2 px-[26px] py-6">
            <div className="font-mono text-[0.66rem] tracking-[0.08em] text-ink-2 uppercase">
          ...
          <div className="min-h-[470px] rounded-[10px] border border-line border-t-4 border-t-accent-deep bg-panel px-[26px] py-6">
            <div className="font-mono text-[0.66rem] tracking-[0.08em] text-ink-2 uppercase">
            ...
            <div className="border-b border-dashed border-line-soft py-3.5 last:border-b-0">
              ...
              <div className="rounded-[7px] border border-[rgba(37,99,235,0.2)] bg-[rgba(37,99,235,0.05)] px-3 py-2.5 font-display text-[0.84rem] leading-[1.55] text-ink">
        ...
        <p className="mt-[22px] text-center text-[0.82rem] leading-[1.6] text-ink-2">
